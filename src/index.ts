...
// import pdfParse from "pdf-parse" // Moved to dynamic import to avoid initialization issues
...
async function main() {
	const config = configSchema.parse({
		...
		preserve_formatting: process.env.PRESERVE_FORMATTING !== 'false',
		output_directory: process.env.OUTPUT_DIRECTORY || './converted_documents',
